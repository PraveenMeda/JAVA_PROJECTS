...
public class DFSImplementation{
    ...
    public void addPerson(String person, String connectedPerson){
        connectedPeople.computeIfAbsent(person, _ -> new ArrayList<>()).add(connectedPerson);
        connectedPeople.computeIfAbsent(connectedPerson, _ -> new ArrayList<>()).add(person);
    }
    public List<String> findSocialCircle(String person){
        visited.clear();
    ...
    public static void main(String[] args) {
        ...
        List<String> socialCircle = dfs.findSocialCircle("Bob");
        System.out.println("Social Circle (Recursive): " + socialCircle);
        List<String> socialCircleIterative = dfs.findSocialCircleIterative("Bob");
